...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if(OffRoad.offroad)
            {
                m_LowAccel.volume = m_LowAccel.maxDistance;
                m_HighAccel.volume = m_HighAccel.maxDistance;
                m_HighDecel.volume = m_HighDecel.maxDistance;
                m_LowDecel.volume = m_LowDecel.maxDistance;
                m_LowDecel.volume = m_LowDecel.maxDistance;
